...
void main() {
  test('Método getAll() deve retornar uma lista do objeto PerformerEntity...', () async {
    final datasource = PerformerDatasourceMock();
    ...
    when(() => datasource.getAll()).thenAnswer((_) => Future.value([
        ...
        final repository = PerformerRepository(datasource);
        final result = await repository.getAll();

        expect(result, [isA<PerformerEntity>()]);
  });
}
